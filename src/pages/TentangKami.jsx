...
//       {/* Visi & Misi Section */}
//       <div className="container mx-auto px-6 py-12">
//         <h2 className="text-3xl font-bold text-green-700 text-center mb-6">Visi dan Misi</h2>
...
//               Menjadi jaringan penyedia layanan kesehatan dan produk yang utama dan terpercaya bagi pelanggan.
//             </p>
//           </div>
