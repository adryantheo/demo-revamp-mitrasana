...
const AboutUs = () => {
  ...
  return (
    <div className="flex justify-center w-full bg-white pt-16">
      <section
        id="about"
        // className={`w-4/5 relative overflow-hidden rounded-lg transition-opacity duration-1000 ${
        //   isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
        // }`}
      className={`container mx-auto py-16 px-6 transition-opacity duration-1000 ${
        isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
      ...
      >
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 z-5 bg-gradient-to-r from-white via-white/70 to-transparent"></div>
